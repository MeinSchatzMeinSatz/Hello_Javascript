...
/**
 * 생성자 함수란 new 연산자와 함께 인스턴스를 생성하는 함수
 ...
 *    Book() 함수 전체를 참조하도록 [[Construct]]에 설정하였습니다.
 ...
 *    따라서 생성한 인스턴스의 타입은 Object
 * 5. Book.prototype에 연결된 프로퍼티(메서드)를
